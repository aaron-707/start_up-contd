      ...
      <div className="div-6">
        <div className="overlap-41">
          ...
          <Link className="contact-button-2" to="/contacts">
            <img className="image-6" alt="Image" src="/img/image-3-2.png" />
          ...
          <img className="image-9" alt="Image" src="/img/image-6.png" />
          ...
          <div className="text-wrapper-84">2</div>
        </div>
        ...
        <img
          className="check-box-3"
          alt="Check box"
          src="/img/check-box-1.png"
        />

        <img className="image-10" alt="Image" src="/img/image-4.png" />
        ...
        <div className="overlap-45">
          ...
          <div className="text-wrapper-90">1:04 AM</div>

          <img
            className="information-13"
            alt="Information"
            src="/img/information-1.png"
          />
          ...
          <div className="text-wrapper-92">10:04 AM</div>

          <img
            className="information-14"
            alt="Information"
            src="/img/information-1.png"
          />

          <img className="simcard-15" alt="Simcard" src="/img/simcard-2.png" />

          <img className="simcard-16" alt="Simcard" src="/img/simcard-2.png" />
        </div>

        <div className="overlap-46">
          <div className="overlap-47">
            <p className="tanisha-2">
            ...
            <img
              className="simcard-17"
              alt="Simcard"
              src="/img/simcard-2.png"
            />
          </div>

          <div className="text-wrapper-89">02:04 AM</div>
